   ...
   <table class="table table-striped" style='100%'>
     ...
     <tbody>
      ...
      for ($i = 0; $i < count($globalKey); $i++) {
       echo "<tr  id='" .$globalKey[$i] ."_global' class='global' style='display:none;'>
      ...
      for ($i = 0; $i < count($match1); $i++) {
        ...
        if ($minerGroup != $match2[$i]) {
          echo "<tr style='font-weight:bold; display:none;' class='worker'>
       ...
       echo "<tr id='" .$match1[$i] ."_". $match2[$i] ."' class='worker ". $match2[$i] ." ' ";
        ...
        echo ">
              <th style='display:block; width: 165px !important'> <label>". $match1[$i] ."</label></th>
      ...
      for ($i = 0; $i < count($poolKey1); $i++) {
        if ($poolgroup != $poolKey1[$i]) {
          echo "<tr style='font-weight:bold; display:none;'>
       ...
       echo "<tr id='" .$poolKey1[$i] ."_". $poolKey2[$i] ."' class='". $poolKey2[$i] ."' style='display:none;'>
